...
class EventServiceTest {
    ...
    void shouldResultAllEventsInDbAsListOfDto() {
        // tutaj alternatywnie skorzystalam z faktu, ze klasa wewnetrzna w ItemServiceTest jest statyczna
        // to co bylo pokazane na zajeciach - czyli jej wyciagniecie jako niezalezna klasa jest mniej magiczne :)
